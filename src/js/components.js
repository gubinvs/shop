...
// Макет данных для отрисовки страницы с ТОВАРОМ на которую 
// пользователь перешел ИЗ КАРТОЧКИ ТОВАРА(по артикулу запрос в апи)
export const components = {
    ...
    characteristics: [
        ...
        {name: "Тип устройства", characteristic: "Силовой контактор"},
        {name: "Номинальный ток", characteristic: "18 А (AC-3)"},
        {name: "Напряжение катушки управления", characteristic: "220–240В (AC)"},
        {name: "Рабочее напряжение силовой цепи", characteristic: "до 690 В (AC)"},
        {name: "Количество силовых полюсов", characteristic: "3 NO"},
        {name: "Вспомогательные контакты", characteristic: "1 NO + 1 NC"},
        {name: "Тип подключения", characteristic: "Винтовые зажимы"},
        {name: "Тип крепления", characteristic: "DIN-рейка"},
        {name: "Габаритные размеры (Д × Ш × В)", characteristic: "77 × 45 × 86 мм"},
